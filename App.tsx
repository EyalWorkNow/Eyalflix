              ...
              if (savedMovies.length > 0) {
                  ...
                  return (
                      <div className="relative min-h-screen">
                          ...
                          <div className="relative z-10 space-y-8 md:space-y-12 pb-12 bg-gradient-to-b from-transparent via-[#0d1117] to-[#0d1117] -mt-16 md:-mt-32 px-4 md:px-12 pt-24 md:pt-48 pointer-events-none">
          ...
          default:
              ...
              return (
                <main className="relative z-0">
                  ...
                  <div className="relative z-10 mt-4 md:mt-8 space-y-8 md:space-y-12 pb-24 md:pb-12">
