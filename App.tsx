          ...
          if (currentSeasonIndex !== -1 && currentEpisodeIndex !== -1) {
              ...
              if (currentEpisodeIndex < currentSeason.episodes.length - 1) {
                  ...
                  return {
                      ...
                      thumbnailUrl: nextEp.thumbnailUrl || currentMovie.thumbnailUrl,
                  ...
                  <div className="relative z-30 -mt-8 md:-mt-12 px-4 md:px-12 mb-8 md:mb-12 pointer-events-auto flex justify-center w-full">
                      <div className="flex items-center gap-3 overflow-x-auto scrollbar-hide py-3 px-4 max-w-full justify-center">
                          ...
                          <button 
                              ...
                              className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white font-bold text-sm transition-all whitespace-nowrap hover:scale-105 active:scale-95 shadow-lg"
                          >
                          ...
                          {moods.map((mood) => {
                              ...
                              return (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold transition-all border whitespace-nowrap hover:scale-105 active:scale-95 backdrop-blur-md shadow-lg ${
                                        isActive 
