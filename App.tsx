                          ...
                          {moods.map((mood) => {
                              ...
                              return (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-bold transition-all border whitespace-nowrap hover:scale-105 active:scale-95 backdrop-blur-md shadow-lg focus:ring-2 focus:ring-cyan-500 ${
                                        isActive 
