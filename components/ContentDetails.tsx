...
export const ContentDetails: React.FC<ContentDetailsProps> = ({ 
  ...
  return (
    <div 
        className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-black/80 backdrop-blur-sm transition-opacity duration-300"
        style={{ opacity }}
    >
      <div className="absolute inset-0 cursor-default" onClick={onClose}></div>

      <div className="relative w-full max-w-5xl bg-[#161b22] rounded-2xl my-4 md:my-10 mx-auto overflow-hidden animate-slide-up origin-bottom z-[101] border border-white/10 shadow-2xl shadow-black/50">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
                ...
                <div className="flex flex-wrap items-center gap-4 mb-2">
                     <button 
                        ...
                        className="flex items-center gap-3 bg-white hover:bg-cyan-50 focus:bg-cyan-50 text-black px-8 py-4 rounded-xl font-bold text-xl transition transform active:scale-95 focus:scale-105 focus:ring-4 focus:ring-white/50"
                        autoFocus
                    >
        ...
        {/* Info & Tabs */}
        <div className="px-6 md:px-12 py-6 bg-[#161b22]">
        ...
        {/* Similar Content */}
        <div className="px-4 md:px-12 pb-16 pt-8 border-t border-white/10 bg-[#161b22]">
