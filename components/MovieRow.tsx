    ...
    <div className="group/row relative px-4 md:px-12 z-0 hover:z-20 transition-all duration-300 mb-8">
      ...
      <div className="relative group/track">
        <button 
            ...
            tabIndex={-1} // Not needed for TV remote usually
        >
        ...
        <div 
            ...
            className={`flex overflow-x-auto gap-2 md:gap-4 py-8 -my-8 px-2 scrollbar-hide scroll-smooth items-center snap-x snap-mandatory`} 
        ...
        >
            ...
            {movies.map((movie, index) => (
                <div key={`${movie.id}-${index}`} className="relative flex items-center flex-none scroll-m-12">
                     {isRanked && (
