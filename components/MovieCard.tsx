...
export const MovieCard: React.FC<MovieCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <div className={`w-full h-full rounded-xl md:rounded-2xl overflow-hidden bg-[#161b22] relative transition-all duration-300 md:group-hover:scale-125 md:group-focus:scale-125 md:group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.6)] md:group-focus:shadow-[0_20px_40px_rgba(0,0,0,0.6)] md:group-hover:ring-2 md:group-focus:ring-2 md:group-hover:ring-cyan-500/50 md:group-focus:ring-cyan-500/50 ${rank ? 'ml-6' : ''}`}>
