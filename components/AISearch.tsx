...
export const AISearch: React.FC<AISearchProps> = ({
    ...
    return (
        <div className="min-h-screen pt-20 pb-12 px-4 md:px-12 animate-fade-in relative z-10">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-4xl font-black tracking-tight mb-8">
                    <span className="heading-gradient">חיפוש</span>
                </h2>
                <div className="relative max-w-4xl mx-auto mb-12 group">
                    <div className="relative glass-panel border border-white/10 rounded-2xl flex items-center p-2 group-focus-within:border-cyan-500 group-focus-within:ring-4 group-focus-within:ring-cyan-500/20 transition-all shadow-2xl">
                        <Search className="w-8 h-8 text-cyan-500/50 ml-4 mr-2" />
                        <input
                            ref={inputRef}
                            type="text"
                            value={query}
